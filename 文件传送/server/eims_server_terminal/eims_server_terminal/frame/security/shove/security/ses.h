...
namespace shove
{
    namespace security
    {
        ...
        public:
            ...
            void Encrypt(const char* input, int len, char* output);
            void Decrypt(const char* input, char* output, int len, int* DecryptResultLength);

            int GetEncryptResultLength(const char* input, int len);

        private:

            char* key;

            int ComplementInput(const char* input, int len, char* output);
